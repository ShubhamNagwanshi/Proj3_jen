...
<%@page import="in.co.rays.project_3.controller.ProductNameCtl"%>
...
<body class="hm">
	...
	<div>
		...
		<main>
		<form action="<%=ORSView.PRODUCTNAME_CTL%>" method="post">
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div>
								<%
									List list = (List) request.getAttribute("productId");
								%>
							...
							<div class="md-form">
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("name", request)%></font></br>
								 ...
								 <span class="pl-sm-5"><b>Discription</b> <span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										value="<%=ProductNameCtl.OP_UPDATE%>"> <input
										type="submit" name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=ProductNameCtl.OP_CANCEL%>">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=ProductNameCtl.OP_SAVE%>"> <input type="submit"
										name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=ProductNameCtl.OP_RESET%>">
								</div>
