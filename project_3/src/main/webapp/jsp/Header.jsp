				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PRODUCT_CTL%>"><i
							class="fas fa-file"></i>Add Product</a> <a
					...
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Product Name</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PRODUCTNAME_CTL%>"><i
							class="fas fa-file"></i>Add Product</a> <a
							class="dropdown-item" href="<%=ORSView.PRODUCTNAME_LIST_CTL%>"> <i
							class="fas fa-sort-amount-down"></i>Product List
						</a>
					</div></li>
					<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.ISSUE_CTL%>"><i
							class="fas fa-file"></i>Add Issue</a> <a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.SALARY_CTL%>"><i
							class="fas fa-file"></i>Add Salary</a> <a
					...
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Vehicle Tracking</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.VEHICLE_TRACKING_CTL%>"><i
							class="fas fa-file"></i>Add Vehicle Tracking</a> <a
				...
				<%-- 	<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.LESSION_CTL%>"><i
							class="fas fa-file"></i>Add Lession</a> <a
							class="dropdown-item" href="<%=ORSView.LESSION_LIST_CTL%>"> <i
							class="fas fa-sort-amount-down"></i>Lession List
						</a>
					</div></li>  --%>
