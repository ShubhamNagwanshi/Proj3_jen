...
<%@page import="in.co.rays.project_3.dto.LessionDTO"%>
<%@page import="in.co.rays.project_3.controller.LessionListCtl"%>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.LESSION_LIST_CTL%>"
			method="post">
			...
			<%
				...
				Iterator<LessionDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2">
					<input type="text" name="chapter" placeholder="Enter Chapter"
						class="form-control"
						value="<%=ServletUtility.getParameter("chapter", request)%>">
				</div>
				<%-- &emsp;
				...
				<div class="col-sm-2">
					...
					&emsp;
				<div class="col-sm-2">
					<input type="text" name="chapterName" placeholder="Enter ChapterName"
						class="form-control"
						value="<%=ServletUtility.getParameter("chapterName", request)%>">
				</div>
 ...
 <center>
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=LessionListCtl.OP_SEARCH%>"> &emsp; <input
						type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
						name="operation" value="<%=LessionListCtl.OP_RESET%>">
				</div>
</center>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #87CEEB;">
							...
							<th width="15%" class="text">Chapter</th>
							<th width="20%" class="text">Date</th>
							<th width="10%" class="text">ChapterName</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getChapter()%></td>
							<td class="text"><%=DataUtility.getDateString(dto.getDate())%></td>
							<td class="text"><%=dto.getChapterName()%></td>
							<td class="text"><a href="LessionCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=LessionListCtl.OP_PREVIOUS%>"
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=LessionListCtl.OP_NEXT%>"
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">Lession List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
