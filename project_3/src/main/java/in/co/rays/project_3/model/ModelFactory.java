...
public final class ModelFactory {
	...
	public LessionModelInt getLessionModel() {
		...
		if (lessionModel == null) {
			if ("Hibernate".equals(DATABASE)) {
				lessionModel = new LessionModelHibImp();
			}
			/*
			 * if ("JDBC".equals(DATABASE)) { bankModel = new UserModelJDBCImpl(); }
			 */
	...
	public ProductNameInt getProductNameModel() {

		ProductNameInt productNameModel = (ProductNameInt) modelCache.get("productNameModel");
		if (productNameModel == null) {
			if ("Hibernate".equals(DATABASE)) {
				productNameModel = new ProductNameHibImp();
			}
			/*
			 * if ("JDBC".equals(DATABASE)) { bankModel = new UserModelJDBCImpl(); }
			 */
			modelCache.put("productNameModel", productNameModel);
		}
