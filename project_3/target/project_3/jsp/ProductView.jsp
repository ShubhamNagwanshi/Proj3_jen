							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="pName"
											...
											value="<%=DataUtility.getStringData(dto.getpName())%>">
									</div>
								</div>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" id="datepicker2" name="pDate"
											class="form-control" placeholder=" Enter Date "
											readonly="readonly"
											value="<%=DataUtility.getDateString(dto.getpDate())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("pDate", request)%></font></br>


								<span class="pl-sm-5"><b>Product Type</b><span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<%=HTMLUtility.getList("product", String.valueOf(dto.getProductType()), list)%>
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("productType", request)%></font></br>
								<%-- 
								<%
								if (dto.getId()==null||id<=0) {
								%> --%>
