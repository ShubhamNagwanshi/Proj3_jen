...
<%@page import="in.co.rays.project_3.model.ProductNameInt"%>
	...
	<div>
		<form class="pb-5" action="<%=ORSView.PRODUCT_LIST_CTL%>"
			...
			<%
				...
				ProductNameDTO rbean1 = new ProductNameDTO();
				ProductNameInt pmodel = ModelFactory.getInstance().getProductNameModel();
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2"><%=HTMLUtility.getList("product", String.valueOf(dto.getProductType()), list1)%></div>
				&emsp;
				<%-- &emsp;
				...
				<div class="col-sm-2">
					<input type="text" name="pDate" class="form-control"
						placeholder="Enter PurchaseDate " id="datepicker"
						readonly="readonly"
						value="<%=DataUtility.getDateString(dto.getpDate())%>">
				</div>
				&emsp;
				<div class="col-sm-2">
					<input type="text" name="price" placeholder="Enter Status"
						class="form-control"
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #87CEEB;">
							...
							<th width="15%" class="text">Product Type</th>
					...
					<%
						while (it.hasNext()) {
								dto = it.next();
						/* ProductNameDTO	pdto =	pmodel.findByPK(dto.getProductType()); */
					%>
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getpName()%></td>
							<td class="text"><%=dto.getProductType()%></td>
							<td class="text"><%=DataUtility.getDateString(dto.getpDate())%></td>
