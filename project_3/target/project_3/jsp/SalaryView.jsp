								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="number" class="form-control" name="amount"
											placeholder=" Enter Amount"   oninput="numberLength(this)"
											 maxlength="6"
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="mobileNumber"
											oninput="validateMobileNo(event)" name="mobileNumber" maxlength="10"
											placeholder="Enter 10 digit mobile No"
											value="<%=DataUtility.getStringData(dto.getMobileNumber()).equals("0")? "" : DataUtility.getStringData(dto.getMobileNumber())%>">
