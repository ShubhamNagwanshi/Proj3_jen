...
<%@page import="in.co.rays.project_3.dto.ProductNameDTO"%>
<%@page import="in.co.rays.project_3.controller.ProductNameListCtl"%>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.PRODUCTNAME_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.ProductNameDTO"
				scope="request"></jsp:useBean>
			<%
				List list1 = (List) request.getAttribute("productId");
			...
			<%
				...
				Iterator<ProductNameDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
			...
			<div class="row">
				...
				<%-- <div class="col-sm-2">
					<input type="text" name="pQuantity"
						placeholder="Enter ProductType" class="form-control"
						value="<%=ServletUtility.getParameter("pQuantity", request)%>">
				</div> --%>
				<%-- &emsp;
				<div class="col-sm-2"><%=HTMLUtility.getList("productId", String.valueOf(dto.getProductId()), list1)%></div>
				&emsp; --%>
				<%-- &emsp;
 ...
 --%>
					...
					<div class="col-sm-2">
						<input type="submit" class="btn btn-primary btn-md"
							...
							value="<%=ProductNameListCtl.OP_SEARCH%>"> &emsp; <input
							type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
							name="operation" value="<%=ProductNameListCtl.OP_RESET%>">
					</div>
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=ProductNameListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>

					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=ProductNameListCtl.OP_NEW%>"></td>

					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=ProductNameListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=ProductNameListCtl.OP_NEXT%>"
			...
			<div class="row">
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=ProductNameListCtl.OP_BACK%>">
				</div>
